...
const controller = (() => {
  ...
  function loadNotes() {
    ...
    const settingsString = localStorage.getItem(SIMPLE_SETTINGS_STORAGE_KEY);
  ...
  function exportFile() {
    let settings = JSON.parse(
      localStorage.getItem(SIMPLE_SETTINGS_STORAGE_KEY)
    );
  ...
  function importFile() {
    ...
    let importSetting = settings["import"]
